...
namespace Pacurar_Viorel_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Pacurar_Viorel_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Pacurar_Viorel_Lab8Context context,
